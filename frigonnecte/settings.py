"""
Django settings for frigonnecte project.
...
SECRET_KEY = 'django-insecure-zy^w)y#0dk841g3mn^u@h)q%u8j$4kv8%=-5bdup1ef$^a^(3+'
...
WSGI_APPLICATION = 'frigonnecte.wsgi.application'
